...
let
  ...
  config = {
    ...
    packageOverrides = pkgs : rec {
      ...
      perlDBICross = pkgs.lib.overrideDerivation pkgs.perlPackages.DBI { stdenv = pkgs.makeStdenvCross pkgs.stdenv crosssystem binutilsCross pkgs.gccCrossStageFinal; };
