...
let
  ...
  config = {
    ...
    packageOverrides = pkgs : rec {
      ...
      perlDBICross = (pkgs.makeOverridable (pkgs.makeStdenvCross pkgs.stdenv crosssystem binutilsCross pkgs.gccCrossStageFinal) (pkgs.perlPackages.DBI));
      perlDBDSQLiteCross = (pkgs.makeOverridable (pkgs.makeStdenvCross pkgs.stdenv crosssystem binutilsCross pkgs.gccCrossStageFinal) (pkgs.perlPackages.DBDSQLite));
      perlWWWCurlCross = (pkgs.makeOverridable (pkgs.makeStdenvCross pkgs.stdenv crosssystem binutilsCross pkgs.gccCrossStageFinal) (pkgs.perlPackages.WWWCurl));
